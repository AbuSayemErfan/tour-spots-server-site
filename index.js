...
const corsOptions = {
  origin: [
    // "http://localhost:5173",
    // "http://localhost:5174",
    // "https://travel-tour-ef419.firebaseapp.com",
    // "https://travel-tour-ef419.web.app",
    "https://bespoke-rolypoly-92e508.netlify.app",
  ],
  credentials: true,
};
// middleware
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.b51euje.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
